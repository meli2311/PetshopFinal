    ...
    <div class="card-body">
      <form method="post" action="{{route('product.store')}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Ingresa el titulo"  value="{{old('title')}}" class="form-control">
          @error('title')
        ...
        <div class="form-group">
          ...
          <select name="size[]" class="form-control selectpicker"  multiple data-live-search="true">
              ...
              <option value="S">Pequeño (P)</option>
              <option value="M">Mediano (M)</option>
              <option value="L">Grande (G)</option>
              <option value="XL">Super Grande (XL)</option>
          </select>
        </div>
        ...
        <div class="form-group">
          ...
          <select name="condition" class="form-control">
              ...
              <option value="default">Nuevo</option>
              <option value="new">Buen estado</option>
              <option value="hot">Defectuoso - aceptable</option>
          </select>
        </div>

        <div class="form-group">
          <label for="stock">Stock <span class="text-danger">*</span></label>
          <input id="quantity" type="number" name="stock" min="0" placeholder="Ingresar stock"  value="{{old('stock')}}" class="form-control">
          @error('stock')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
