    ...
    <ul class="navbar-nav ml-auto">
          ...
          <form class="form-inline mr-auto w-100 navbar-search">
            <div class="input-group">
              ...
              <div class="input-group-append">
                <button class="btn btn-primary" type="button" aria-label="Busqueda">
      ...
      <li class="nav-item dropdown no-arrow">
        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          @if(Auth()->user()->photo)
            <img class="img-profile rounded-circle" src="{{Auth()->user()->photo}}" loading="lazy" draggable="false">
          @else
            <img class="img-profile rounded-circle" src="{{asset('backend/img/avatar.png')}}" loading="lazy" draggable="false">
          @endif
        </a>
        ...
        <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
          ...
          <a class="dropdown-item" href="{{ route('logout') }}"
                onclick="event.preventDefault();
                 ...
                 <i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i> {{ __('Salir') }}
            </a>
