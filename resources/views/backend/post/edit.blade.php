    ...
    <div class="card-body">
      <form method="post" action="{{route('post.update',$post->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Ingresar titulo"  value="{{$post->title}}" class="form-control">
          @error('title')
        ...
        <div class="form-group">
          <label for="quote" class="col-form-label">Cita</label>
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
            ...
            <option value="inactive" {{(($post->status=='inactive')? 'selected' : '')}}>Inactivo</option>
        </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
