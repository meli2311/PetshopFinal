    ...
    <div class="card-body">
      <form method="post" action="{{route('category.update',$category->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="title" placeholder="Ingresa el titulo"  value="{{$category->title}}" class="form-control">
          @error('title')
        ...
        <div class="form-group">
          <label for="is_parent">Categoria Principal</label><br>
      ...
      <div class="form-group {{(($category->is_parent==1) ? 'd-none' : '')}}" id='parent_cat_div'>
          ...
          <select name="parent_id" class="form-control">
              <option value="">--Selecciona con que categoria se relaciona--</option>
