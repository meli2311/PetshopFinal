            ...
            @foreach($categories as $category)
              ...
              @endphp
                <tr>
                    ...
                    <td>
                        @if($category->photo)
                            <img src="{{$category->photo}}" class="img-fluid" style="max-width:80px" alt="{{$category->photo}}" draggable="false">
                        @else
                            <img src="{{asset('backend/img/thumbnail-default.jpg')}}" class="img-fluid" style="max-width:80px" alt="avatar.png" draggable="false">
                        @endif
                    </td>
                    <td>
