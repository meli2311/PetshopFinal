...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      ...
      <a href="{{route('category.create')}}" class="btn btn-primary btn-sm float-right" data-toggle="tooltip" data-placement="bottom" title="Add User"><i class="fas fa-plus"></i> Agregar categoria</a>
    </div>
    <div class="card-body">
      <div class="table-responsive">
        ...
        <table class="table table-bordered" id="banner-dataTable" width="100%" cellspacing="0">
          <thead>
            <tr>
              ...
              <th>Titulo</th>
              <th>Tipo</th>
              <th>Es una Categoria Principal</th>
            ...
            @foreach($categories as $category)
              ...
              @endphp
                <tr>
                    ...
                    <td>
                        @if($category->photo)
                            <img src="{{$category->photo}}" class="img-fluid" style="max-width:80px" alt="{{$category->photo}}" loading="lazy" draggable="false">
                        @else
        ...
        @else
          <h6 class="text-center">
            ¡¡¡No se encontraron categorías!!! Por favor crea una categoría</h6>
        @endif
      </div>
    </div>
</div>
