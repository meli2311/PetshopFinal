          ...
          <tbody>
            @foreach($users as $user)   
                <tr>
                    ...
                    <td>
                        @if($user->photo)
                            <img src="{{$user->photo}}" class="img-fluid rounded-circle" style="max-width:50px" alt="{{$user->photo}}" loading="lazy" draggable="false">
                        @else
                            <img src="{{asset('backend/img/avatar.png')}}" class="img-fluid rounded-circle" style="max-width:50px" alt="avatar.png" loading="lazy" draggable="false">
                        @endif
                    </td>
