                    ...
                    <div class="single-footer about">
                        <div class="logo">
                            <a href="index.html" draggable="false">
                                <img src="{{ asset('backend/img/logo2.png') }}" alt="#" loading="lazy" draggable="false">
                            </a>
                        </div>
                        @php
            ...
            <div class="inner">
                <div class="row">
                    <div class="col-lg-6 col-12">
                        <div class="left">
                            <p>Copyright © {{ date('Y') }} <a href="https://github.com/meli2311"
                                    target="_blank">Melissa Ponce</a> - Reservados todos los derechos de el autor.</p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-12">
                        <div class="right">
                            <img src="{{ asset('backend/img/payments.png') }}" alt="#" loading="lazy" draggable="false">
                        </div>
                    </div>
                </div>
            </div>
