...
@section('main-content')
						...
						<div class="col-lg-8 col-12">
							<div class="form-main">
								<div class="title">
									...
									<h3>Escríbenos un mensaje @auth @else<span style="font-size:12px;" class="text-danger">[You need to login first]</span>@endauth</h3>
								</div>
									...
									<div class="row">
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input name="name" id="name" type="text" placeholder="Ingresa tus nombres">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
												<label>Asunto<span>*</span></label>
												<input name="subject" type="text" id="subject" placeholder="Ingresa tu asunto">
											</div>
										</div>
										<div class="col-lg-6 col-12">
											<div class="form-group">
										...
										<div class="col-lg-6 col-12">
											<div class="form-group">
												...
												<input id="phone" name="phone" type="number" placeholder="Ingresa tu celular">
											</div>	
										</div>
										<div class="col-12">
						...
						<div class="col-lg-4 col-12">
							<div class="single-head">
								<div class="single-info">
									...
									<h4 class="title">Llamanos ahora :</h4>
									<ul>
								...
								<div class="single-info">
									...
									<h4 class="title">Nuestra direccion:</h4>
									<ul>
		...
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			...
			<div class="modal-body">
				<p class="text-success">Su mensaje fue enviado con éxito...</p>
			</div>
		  </div>
		</div>
	</div>
	...
	<div class="modal fade" id="error" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
		  <div class="modal-content">
			<div class="modal-header">
				<h2 class="text-warning">Lo siento!</h2>
				<button type="button" class="close" data-dismiss="modal" aria-label="Close">
					<span aria-hidden="true">&times;</span>
				</button>
			</div>
