                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Barra lateral única del blog</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="blog-detail">
                                    ...
                                    <div class="blog-meta">
                                        <span class="author"><a href="javascript:void(0);"><i class="fa fa-user"></i>By {{$post->author_info['name']}}</a><a href="javascript:void(0);"><i class="fa fa-calendar"></i>{{$post->created_at->format('M d, Y')}}</a><a href="javascript:void(0);"><i class="fa fa-comments"></i>Comenta ({{$post->allComments->count()}})</a></span>
                                    </div>
                            ...
                            <div class="col-12 mt-4">
                                <div class="reply">
                                    <div class="reply-head comment-form" id="commentFormContainer">
                                        <h2 class="reply-title">Deja un comentario</h2>
                                        <!-- Comment Form -->
                            ...
                            <p class="text-center p-5">
                                Necesitas<a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Ingresar</a> OR <a style="color:blue" href="{{route('register.form')}}">Registrarte</a>para comentar.
                    ...
                    <div class="main-sidebar">
                        ...
                        <div class="single-widget newsletter">
                            ...
                            <div class="letter-inner">
                                <h4>Suscríbete y recibe noticias <br> últimas actualizaciones.</h4>
