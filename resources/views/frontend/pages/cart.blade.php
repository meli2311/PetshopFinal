								...
								@else
										<tr>
											<td class="text-center">
												No hay carritos disponibles. <a href="{{route('product-grids')}}" style="color:blue;">Continua comprando</a>
...
>>>>>>> 6ef68cfb76da90f7c6f0b47861090b4dac5b4941
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li class="order_subtotal" data-price="{{Helper::totalCartPrice()}}">Subtotal del carrito<span>S/{{number_format(Helper::totalCartPrice(),2)}}</span></li>

										@if(session()->has('coupon'))
										<li class="coupon_price" data-price="{{Session::get('coupon')['value']}}">Ahorrar<span>S/{{number_format(Session::get('coupon')['value'],2)}}</span></li>
										@endif
										@php
										...
										@endphp
										@if(session()->has('coupon'))
											<li class="last" id="order_total_price">Pagar<span>S/{{number_format($total_amount,2)}}</span></li>
										@else
											<li class="last" id="order_total_price">Pagar<span>S/{{number_format($total_amount,2)}}</span></li>
										@endif
									</ul>
									<div class="button5">
										<a href="{{route('checkout')}}" class="btn">Realizar el pago</a>
