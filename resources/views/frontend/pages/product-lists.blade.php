                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li class="active"><a href="javascript:void(0);">Lista de compras</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="shop-sidebar">
                            ...
                            <div class="single-widget recent-post">
                                <h3 class="title">Reciente publicacion</h3>
                                {{-- {{dd($recent_products)}} --}}
                                                    ...
                                                    <div class="product-img">
                                                        ...
                                                        <div class="button-head">
                                                            ...
                                                            <div class="product-action-2">
                                                                <a title="Add to cart"
                                                                    href="{{ route('add-to-cart', $product->slug) }}">Agregar
                                                                    al carrito</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-lg-8 col-md-6 col-12">
                                                <div class="list-content">
                                                    ...
                                                    <a href="javascript:void(0)" class="btn cart"
                                                        data-id="{{ $product->id }}">Compra ahora!</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="quickview-content">
                                        ...
                                        <div class="quickview-ratting-review">
                                            ...
                                            <div class="quickview-stock">
                                                @if ($product->stock > 0)
                                                    <span><i class="fa fa-check-circle-o"></i> {{ $product->stock }}conn
                                                        stock</span>
                                                @else
                                                    <span><i class="fa fa-times-circle-o text-danger"></i>
                                                        {{ $product->stock }} sin stock</span>
                                                @endif
                                            </div>
                                        </div>
                                        @php
